...
# ===========================================================================
HOST = "agaaz"   # shown as  agaaz@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "B.Tech CS @ Thapar Institute '29"),
    ("kv", "Edu", "12th CBSE (PCM), 88.6%"),
    ("kv", "Focus", "Full-Stack Web Development"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "HTML5, CSS3, JS (ES6+), React"),
    ("kv", "Backend", "Node.js, Express.js"),
    ("kv", "Languages", "Java, Python, C++"),
    ("kv", "Tools", "Git, MongoDB, MySQL, Docker"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "1st Prize - CorpEureka 2.0 Ideathon '25"),
    ("bul", "Most Promising Coder - CAPTA CAELUM '22"),
    ("bul", "3rd Place - IPSC IT FEST (National) '22"),
]
